...
import type { IVariation, IProduct } from "@/types/productTypes";
...
export default function AddVariationModal({
  ...
  const handleChange = (
    ...
    if (name.startsWith("atributos.")) {
      ...
      setVariation((prev) => ({
        ...prev,
        [name]:
          name === "descripcion" || name === "medida" ? value : Number(value),
      }));
    }
  };
  ...
  const removeVariation = async (index: number) => {
    ...
    console.log("variacion a borrar", variationToRemove);
    setIsLoading(true);
    setError("");
          ...
          <form onSubmit={handleSubmit}>
              ...
              {activeTab === "atributos" && (
                <div className={sectionClass}>
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      <label htmlFor="atributos.altura" className={labelClass}>
                        Altura (cm)
                      </label>
                      <input
                        id="atributos.altura"
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label htmlFor="atributos.calibre" className={labelClass}>
                        Calibre
                      </label>
                      <input
                    ...
                    <div>
                      <label htmlFor="atributos.color" className={labelClass}>
                        Color
                      </label>
                      <input
                        id="atributos.color"
            ...
            <div className="mb-6">
              <button
                ...
                disabled={
                  isLoading || !variation.medida.trim() || variation.precio <= 0
                }
              >
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto border rounded p-2">
                {variations.length > 0 ? (
                  variations.map((v, index) => (
                    ...
                    >
                      <div>
                        <span className="font-medium">{v.medida}</span> - $
                        {v.precio.toFixed(2)}
