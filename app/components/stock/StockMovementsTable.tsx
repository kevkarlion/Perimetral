...
export default function StockMovementsTable({
  ...
  const getProductInfo = (movement: ExtendedStockMovement) => {
    return {
      ...
      codigo:
        movement.productCode || movement.product?.codigoPrincipal || "N/A",
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="p-3 text-center font-medium text-gray-700 whitespace-nowrap">
                  Cantidad
                </th>
                <th className="p-3 text-center font-medium text-gray-700 whitespace-nowrap">
                  Stock Ant.
                  ...
                  >
                    ...
                    <td className="p-3 max-w-[180px]">
                      <div className="truncate">
                        <div
                          ...
                          title={productInfo.nombre}
                        >
                          {productInfo.nombre}
                        </div>
                        <div
                          className="text-xs text-gray-500 truncate"
                          title={productInfo.codigo}
                        >
                          {productInfo.codigo}
                        </div>
                      </div>
                    ...
                    {/* <td className="p-3">
                      <div className="relative max-w-[100px]">
                        <button
                          onClick={() =>
                            copyToClipboard(productId, `prod-${movementId}`)
                          }
                    ...
                    <td className="p-3 max-w-[120px]">
                      {variationInfo ? (
                        <div className="truncate">
                          <div
                            className="font-medium text-gray-900 truncate"
                            title={variationInfo.nombre}
                          >
                            {variationInfo.nombre}
                          </div>
                          <div
                            className="text-xs text-gray-500 truncate"
                            title={variationInfo.codigo}
                          >
                    ...
                    {/* Razón */}
                    <td
                      className="p-3 text-sm text-gray-700 max-w-[200px] truncate"
                      title={m.reason}
                    >
                      {m.reason}
                      {m.notes && (
              ...
              >
                ...
                {variationInfo && (
                  <div className="mb-2">
                    ...
                    {/* ID de la variación en mobile */}
                    {variationId !== "N/A" && (
                      <button
                        onClick={() =>
                          copyToClipboard(variationId, `var-${movementId}`)
                        }
                        className="mt-1 font-mono text-xs text-blue-600 hover:text-blue-800 hover:underline 
                   cursor-pointer transition-all bg-blue-50 px-2 py-1 rounded truncate"
                        title="Haz clic para copiar el ID completo"
                      >
                        {showRawIds
                          ? variationId
